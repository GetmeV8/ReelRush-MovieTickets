...
<Link to="/admin/theater-list" style={{ textDecoration: "none" }}>
  <li>
...
<p className="title">BOOKING MANAGMENT</p>
          <Link to="/admin/userBooking" style={{ textDecoration: "none" }}>
            <li>
          ...
          <Link to="/admin/theaterBooking" style={{ textDecoration: "none" }}>
            <li>
              <BookOnlineIcon className="icon" />
...
<p className="title">POSTER MANAGMENT</p>
          <Link to="/admin/addPoster" style={{ textDecoration: "none" }}>
            <li>
          ...
          <br />
          <Link style={{ textDecoration: "none" }} to="/admin/listPoster">
            <li>
          ...
          <Link style={{ textDecoration: "none" }} to="/admin/addgenre">
            <li>
              <MovieIcon className="icon" />
              <span>ADD GENRE</span>
            </li>
          ...
          <Link to="/admin/addMovies" style={{ textDecoration: "none" }}>
            <li>
